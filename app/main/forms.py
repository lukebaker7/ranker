...
from wtforms import StringField, SubmitField, TextAreaField, URLField, SelectField, HiddenField
...
class ItemUpdateForm(FlaskForm):
    ...
    description = TextAreaField('Description', validators=[Length(min=0, max=120)])
    submit = SubmitField('Submit')
